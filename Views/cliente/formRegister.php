...
<h1 class="text-center mt-2">Registro de cliente</h1>
<div class="container">
    <?php if(isset($_SESSION['register']) && $_SESSION['register'] == 'success'): ?>
        <h2 class="alert alert-success text-center" role="alert">Cliente creado correctamente<i class="fas fa-check-circle ml-3"></i></h2>
    <?php elseif(isset($_SESSION['register']) && $_SESSION['register'] == 'failed'): ?>
        <h2 class="alert alert-danger text-center" role="alert">Error al crear cliente<i class="fas fa-times ml-3"></i></h2>
    <?php endif; ?>
    <?php Utils::deleteSession('register')?>
    <div class="justify-content-center">
        <form action="<?=baseUrl?>Cliente/register" class="my-3" method="POST">
            <div class="form-row">
